...
namespace UIElementsUnturned.Samples.RocketMod.Hard.RocketModHardSample.UI.Elements.Buttons
{
    /// <summary>
    ...
    public sealed class CloseUIButton : IButton
    {
        ...
        /// </summary>
        private readonly IAsset<PluginConfiguration> configurationAsset;
        ...
        /// </summary>
        public CloseUIButton(IAsset<PluginConfiguration> configurationAsset)
        {
